...
if (!function_exists('get_otp_config')) {
    function get_otp_config($key, $default = null, $lang = false)
    {
        $settings = Cache::remember('otp_configurations', 86400, function () {
            return OtpConfiguration::all();
        });
