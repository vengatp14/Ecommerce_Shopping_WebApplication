...
Route::group(['prefix' => 'v2/auth', 'middleware' => ['app_language']], function () {
    ...
    Route::post('loginbyphone', 'App\Http\Controllers\Api\V2\AuthController@login_by_phone');
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('all-delivery-status', 'App\Http\Controllers\Api\V2\DeliveryBoyController@all_delivery_status')->middleware('auth:sanctum');
    ...
    Route::get('middle-banner', 'App\Http\Controllers\Api\V2\BannerController@banner2');
    ...
    Route::get('color-settings', 'App\Http\Controllers\Api\V2\BusinessSettingController@colorCodes');
