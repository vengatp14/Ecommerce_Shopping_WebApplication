...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    //Dashboard
    Route::post('/dashboard/inhouse-top-categories', [AdminController::class, 'inhouseTopCategories'])->name('inhouse.topcategories');
    Route::post('/dashboard/inhouse-top-brands', [AdminController::class, 'inhouseTopBrands'])->name('inhouse.topbrands');
    // category
