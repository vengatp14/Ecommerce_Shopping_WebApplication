        ...
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <div class="bg-white rounded shadow-sm p-4 text-left">
                    ...
                    <p class="mb-4 opacity-60">{{translate('Enter your new password and confirm password.')}} </p>
                    <form method="POST" action="{{ route('password.update.phone') }}">
                        ...
                        <div class="form-group phone-form-group">
                            <input type="tel" id="phone-code"
                                ...
                                value="{{ isset($user->phone) ? $user->phone : (isset($phone) ? $phone : '') }}" placeholder="" name="phone" autocomplete="off">
                        </div>

                        <input type="hidden" name="country_code" value="">

                        <div class="form-group">
                            <input id="code" type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" name="code" value="{{ $email ?? old('code') }}" placeholder="{{translate('OTP')}}" required autofocus>
