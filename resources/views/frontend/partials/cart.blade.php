...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}">
    <span class="position-relative d-inline-block">
        ...
        <span class="cart-count badge badge-primary badge-inline badge-pill absolute-top-right--10px">{{count($carts) > 0 ? count($carts) : 0 }}</span>
    </span>
</a>
