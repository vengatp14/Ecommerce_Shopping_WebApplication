        ...
        <div class="row">
                ...
                <div class="mb-4">
                    <a href="{{ route('home') }}" class="d-block">
                        @if(get_setting('footer_logo') != null)
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="104" style="height: 104px;">
                        @else
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="text-center text-sm-left mt-4">
                            <h5 class="fs-14 text-secondary text-uppercase fw-700 mb-3">{{ translate('Subscribe Us') }}</h5>
                            <div class="mb-3">
                                <form method="POST" action="{{ route('subscribers.store') }}">
                                    @csrf
                                    <div class="row gutters-10 mx-0">
                                        <div class="col-8 p-0">
                                            <input type="email" class="form-control border-secondary rounded-0 text-white w-100 bg-transparent fs-12" placeholder="{{ translate('Your Email Address') }}" name="email" required>
                                        </div>
                                        <div class="col-4 p-0">
                                            <button type="submit" class="btn btn-primary rounded-0 w-100 px-0"><span class="fs-12">{{ translate('Subscribe') }}</span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
