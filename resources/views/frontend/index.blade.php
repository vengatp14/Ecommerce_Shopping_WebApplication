...
@section('content')
    ...
    <div class="home-banner-area mb-3 mt-3" style="">
            ...
            <div class="container">
                <div class="bg-white">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        ...
                        <!-- Links -->
                        <div class="d-flex">
                            <a type="button" class="arrow-prev slide-arrow mr-2" onclick="clickToSlide('slick-prev','featured_category_section')"><i class="las la-angle-left fs-20 fw-600"></i></a>
                            <a type="button" class="arrow-next slide-arrow ml-2" onclick="clickToSlide('slick-next','featured_category_section')"><i class="las la-angle-right fs-20 fw-600"></i></a>
                        </div>
                    </div>
                </div>
                <!-- Categories -->
                <div class="bg-white" id="featured_category_section">
                    <div class="aiz-carousel sm-gutters-17 arrow-none" data-items="4" data-xxl-items="5" data-xl-items="4"
                        data-lg-items="4" data-md-items="4" data-sm-items="2" data-xs-items="2" data-arrows="true"
                        data-dots="false" data-autoplay="true" data-infinite="true">
                        @foreach ($featured_categories as $key => $category)
                            @php
                                $category_name = $category->getTranslation('name');
                            @endphp
                            <div class="carousel-box position-relative text-center">
                                <a href="{{ route('products.category', $category->slug) }}" class="text-decoration-none text-inherit" tabindex="-1">
                                    <div class="card card-product mb-lg-4">
                                        <div class="card-body text-center py-8">
                                            <img src="{{ isset($category->catIcon->file_name) ? my_asset($category->catIcon->file_name) : static_asset('assets/img/placeholder.jpg') }}" alt="{{ $category->getTranslation('name') }}"
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" class="mb-3 lazyload has-transition" width="100">
                                            <div class="text-truncate">{{ $category_name }}</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
